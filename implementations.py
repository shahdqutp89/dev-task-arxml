...
class ElementManipulator(IElementManipulator):
    def add_attribute(
        self, element: ET.Element, attr_name: str, attr_value: str
    ) -> None:
    ...
    def edit_attribute(
        self, element: ET.Element, attr_name: str, new_value: str
    ) -> bool:
        if attr_name in element.attrib:
...
class ElementFinder(IElementFinder):
    ...
    def find_element_by_attribute(
        self, root: ET.Element, attr_name: str, attr_value: str
    ) -> List[ET.Element]:
